...
const Appointment = () => {
  ...
  return docInfo && (
    <div>
      ...
      <div className='flex flex-col md:flex-row gap-4'>
        ...
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          ...
          <div className='flex items-center gap-2 text-sm mt-1 text-gray-600 '>
            ...
            <button className='py-0.5 px-2 border cursor-pointer'>{docInfo.experience}</button>
          </div>

          {/* about doctor */}

          <div>
            <p className='flex items-center gap-1 text-sm font-medium '>About <img src={assets.info_icon} alt="" /> </p>
      ...
      <div className='flex flex-col items-center sm:pl-2 mt-10 w-[100%] font-medium text-gray-600'>
        <p className='underline text-xl'>Booking Slots</p>
        <p className='mt-2 text-lgx'>Pick a day</p>
      ...
      <div className='flex items-center flex-wrap gap-3 w-full lg:mt-16'>
      ...
      <div className='flex flex-col items-center'>
        <button onClick={bookAppointment} className='bg-[#5f6FFF] text-white text-sm font-light px-14 py-3 rounded-full my-6 border-gray-300'>Book an appointment </button>
      </div>
