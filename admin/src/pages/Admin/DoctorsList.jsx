      ...
      <div className='flex flex-wrap gap-4 pt-5 gap-y-6 '>
        {
          doctors.map((eachItem,index)=>(
            <div className='border border-indigo-200 rounded-lg max-w-40 xl:max-w-56 overflow-hidden cursor-pointer hover:translate-y-[-10px] transition-all duration-500 group' key={index}>
